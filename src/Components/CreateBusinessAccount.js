...
const CreateBusinessAccount = () => {
  ...
  const handleCreateBusinessAccount = (e) => {
    e.preventDefault();
    // Logic to handle account creation
    console.log("Business account created with:", { businessName, ownerName, mobile, email, password });
  };
    ...
    <div className="min-h-screen bg-gray-100 flex justify-center items-center py-12">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <div className="mb-6 text-center">
          <h1 className="text-3xl font-semibold text-green-900">Create Business Account</h1>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">Already have an account? <Link to="/signin" className="text-green-500 hover:text-green-600">Sign in</Link></p>
        </div>
